...
访问这些链接，跳转到如图页面：
 ...
 ![](http://img-upaiyun-own.test.upcdn.net/3-1.png)

### 问题处理：

1、打开电脑文件夹选项卡，取消”隐藏受保护的操作系统文件“勾选，把”隐藏文件和文件夹“下面的单选选择“显示隐藏的文件、文件夹和驱动器”。

![](http://img-upaiyun-own.test.upcdn.net/3-2.png)

2、再次查看，可以看到半透明的文件夹，清楚隐藏文件夹及所有页面

![](http://img-upaiyun-own.test.upcdn.net/3-3.png)

3、然后清除IIS临时压缩文件

`C:\inetpub\temp\IIS Temporary Compressed Files\WEBUI\$^_gzip_D^\WEB\WEBUI\UPLOAD`

![](http://img-upaiyun-own.test.upcdn.net/3-4.png)
