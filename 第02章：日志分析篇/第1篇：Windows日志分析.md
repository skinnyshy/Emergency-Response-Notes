...
![](http://img-upaiyun-own.test.upcdn.net/log-1-1.png)

**设置2**：设置合理的日志属性，即日志最大大小、事件覆盖阀值等： 

![](http://img-upaiyun-own.test.upcdn.net/log-1-2.png)
...
2. 按 "**Window+R**"，输入 ”**eventvwr.msc**“ 也可以直接进入“**事件查看器**” 
   ...
   ![](http://img-upaiyun-own.test.upcdn.net/log-1-3.png)
...
![](http://img-upaiyun-own.test.upcdn.net/log-1-4.png)
...
![](http://img-upaiyun-own.test.upcdn.net/log-1-5.png)
...
![](http://img-upaiyun-own.test.upcdn.net/log-1-6.png)
...
![](http://img-upaiyun-own.test.upcdn.net/log-1-7.png)
...
![](http://img-upaiyun-own.test.upcdn.net/log-1-8.png)
